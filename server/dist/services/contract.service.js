...
async function registerModelGroth16(data) {
    ...
    const tx = await contract.register_model_groth16(model_name, version, model_type, pricing_per_inference, example_input_hash, example_output_hash, a, b_flat, c, public_inputs);
    return tx.wait();
}
