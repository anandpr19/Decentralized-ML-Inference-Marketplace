...
const handleUpload = async (req, res) => {
    try {
        ...
        console.log("hitting contract from upload");
        const registrationResult = await (0, model_controller_1.registerModelInternal)(req.body);
        ...
        const modelRecord = await model_2.Model.create({
            ...
            txHash: registrationResult.tx_hash,
            verified: true,
        });
